...
export class initialMigration1588853971332 implements MigrationInterface {
    name = 'initialMigration1588853971332'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("User_id" SERIAL NOT NULL, "Name" character varying NOT NULL, "Phone" integer NOT NULL, "Email" character varying NOT NULL, "Deleted" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_37806be2a46a9e6a8d00a6bdd2a" PRIMARY KEY ("User_id"))`, undefined);
