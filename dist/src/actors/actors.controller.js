...
const actorDto_1 = require("./DTO/actorDto");
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ActorsController.prototype, "getOne", null);
__decorate([
    common_1.Post(),
    __param(0, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [actorDto_1.actorDto]),
    __metadata("design:returntype", Promise)
], ActorsController.prototype, "add", null);
__decorate([
    common_1.Put(':id'),
    __param(0, common_1.Body()), __param(1, common_1.Param('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [actorDto_1.actorDto, Object]),
    __metadata("design:returntype", Promise)
